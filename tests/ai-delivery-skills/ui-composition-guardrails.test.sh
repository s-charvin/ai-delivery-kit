...
require_contains "$UI_SKILL" 'user-approved workspace'
...
require_contains "$UI_SKILL" 'no active-delivery compatibility path for earlier schemas'
require_contains "$UI_SKILL" 'state/IME matrix'
require_contains "$UI_SKILL" 'semantic component boundary'
require_contains "$REQ_SKILL" 'Do not infer a source'
require_contains "$UI_INDEX_TEMPLATE" '"schema_version": 3'
require_contains "$UI_INDEX_TEMPLATE" '"evidence_scope"'
require_contains "$UI_INDEX_TEMPLATE" '"scope_decision"'
require_contains "$UI_INDEX_TEMPLATE" '"host_binding"'
