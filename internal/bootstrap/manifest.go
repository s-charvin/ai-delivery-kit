...
func Manifest() []ManagedAsset {
	return []ManagedAsset{
		...
		{Source: "", Target: ".cursor/hooks/validate-ui-contract.sh", Kind: "hook_wrapper"},
		...
		{Source: "", Target: ".claude/hooks/validate-ui-contract.sh", Kind: "hook_wrapper"},
		...
		{Source: "", Target: ".codex/hooks/validate-ui-contract.sh", Kind: "hook_wrapper"},
