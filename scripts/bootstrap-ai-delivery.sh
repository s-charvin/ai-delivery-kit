...
main() {
  local target_repo=""
  local os arch archive_name source_desc archive_path checksums_path extracted_dir binary_path
  ...
  log "Downloading temporary ai-delivery binary from ${source_desc}"
